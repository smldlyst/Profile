...
1. Model deployment
: I have experience in developing a recommendation system through R's recosystem package, and I can deploy a model that can upload the plumber API to GCP through docker. **In short, I can work with developers to service machine learning models to customers.**
